  ...
  return (
    ...
    >
      <Coin
        size={size}
        weight="fill"
        className={cn("text-primary [animation:coin-toss_1.35s_linear_infinite]", className)}
        style={{ transformStyle: "preserve-3d" }}
      />
      <span
        aria-hidden
        className="absolute rounded-full bg-foreground/40 blur-[1px] [animation:coin-toss-shadow_1.35s_linear_infinite]"
